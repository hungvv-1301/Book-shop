...
fun httpConnection(
    ...
    try {
        ...
        with(connection) {
            ...
            setRequestProperty(ApiConstants.ATTRIBUTE.CONTENT_TYPE, ApiConstants.ATTRIBUTE.APPLICATION_JSON)
            setRequestProperty(ApiConstants.ATTRIBUTE.ACCEPT, ApiConstants.ATTRIBUTE.APPLICATION_JSON)
            setRequestProperty(ApiConstants.ATTRIBUTE.CHARSET, ApiConstants.ATTRIBUTE.MODE_CHARSET)
            setRequestProperty(ApiConstants.ATTRIBUTE.AUTHORIZATION, "${ApiConstants.ATTRIBUTE.BEARER} $token")
